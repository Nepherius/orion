...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            db_commands::sessions::crud::db_create_session,
            db_commands::sessions::crud::db_update_session,
            db_commands::sessions::crud::db_delete_session,
            db_commands::sessions::crud::db_get_all_sessions,
            db_commands::db_get_all_sessions_summary,
            db_commands::db_clear_all_data,
            db_commands::db_get_session_stats,
            db_commands::sessions::lifetime::db_get_lifetime_stats,
            db_commands::sessions::analytics_stats::db_get_analytics_stats,
            db_commands::sessions::performance::db_get_analytics_performance_data,
            db_commands::sessions::advanced::db_get_analytics_advanced_data,
            db_commands::sessions::creature_stats::db_get_advanced_creature_stats,
            db_commands::sessions::factor_data::db_get_analytics_factor_data,
            db_commands::sessions::loot_theory::db_get_loot_theory_data,
