        ...
        <div className="rounded-lg border border-border bg-white/[0.03] p-4">
          ...
          <div className="flex items-end justify-between h-24 gap-2 mb-2">
            {[
              ...
              <div key={bar.label} className="w-full flex flex-col items-center group relative">
                <div
          ...
          <div className="flex justify-between text-xs text-muted w-full px-1">
            <span className="w-1/5 text-center truncate">&lt;80%</span>
            <span className="w-1/5 text-center truncate">80-90</span>
            <span className="w-1/5 text-center truncate">90-100</span>
            <span className="w-1/5 text-center truncate">100-110</span>
            <span className="w-1/5 text-center truncate">&gt;110%</span>
          </div>
        </div>
      </div>
    </Panel>
