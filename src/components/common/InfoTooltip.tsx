...
export function InfoTooltip({ tooltip }: InfoTooltipProps) {
  return (
    <div className="group relative inline-flex items-center justify-center">
      ...
      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block bg-background text-cyan-300 text-xs rounded px-2 py-1 whitespace-nowrap border border-cyan-500 z-50 shadow-lg">
        {tooltip}
      </div>
    </div>
  );
