...
export const overlayStatDefinitions: OverlayStatDefinition[] = [
  ...
  },
  {
    id: 'costPerKill',
    label: 'Cost/Kill',
    description: 'Average spend per tracked kill.',
    group: 'Costs',
  },
  {
    id: 'adjustedLootPerKill',
    label: 'Adj Loot/Kill',
    description: 'Adjusted loot divided by tracked kills.',
    group: 'Returns',
  },
  {
    id: 'adjustedLootPerPed',
    label: 'Adj Loot/PED',
    description: 'Adjusted loot divided by total spend.',
    group: 'Returns',
  },
  {
    id: 'adjustedLootPerHour',
    label: 'Adj Loot/Hour',
    description: 'Adjusted loot earned per active session hour.',
    group: 'Returns',
  },
  {
    id: 'kills',
  ...
  },
  {
    id: 'avgDps',
    label: 'Avg Dmg/Hit',
    description: 'Average damage dealt per shot fired.',
    group: 'Combat',
  },
  {
    id: 'weaponDpp',
  ...
  },
  {
    id: 'killsPerPed',
    label: 'Kills/PED',
    description: 'Tracked kills divided by total spend.',
    group: 'Combat',
  },
  {
    id: 'killsPerHour',
    label: 'Kills/Hour',
    description: 'Tracked kills per active session hour.',
    group: 'Combat',
  },
  {
    id: 'shotsPerKill',
    label: 'Shots/Kill',
    description: 'Shots fired divided by tracked kills.',
    group: 'Combat',
  },
  {
    id: 'evasionRate',
    label: 'Evasion Rate',
    description: 'Target evades as a percentage of shots fired.',
    group: 'Combat',
  },
  {
    id: 'dodgeRate',
    label: 'Dodge Rate',
    description: 'Target dodges as a percentage of shots fired.',
    group: 'Combat',
  },
  {
    id: 'critRate',
  ...
  },
  {
    id: 'spendPerHour',
    label: 'Spend/Hour',
    description: 'Total spend per active session hour.',
    group: 'Costs',
  },
  {
    id: 'weaponDecay',
  ...
  },
  {
    id: 'skillsPerHour',
    label: 'Skills/Hour',
    description: 'Skill gain value per active session hour.',
    group: 'Progress',
  },
  {
    id: 'damagePerHour',
    label: 'Dmg/Hour',
    description: 'Damage dealt per active session hour.',
    group: 'Combat',
  },
];
